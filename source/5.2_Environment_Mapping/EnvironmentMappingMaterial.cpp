...
namespace Rendering
{
	...
	ComPtr<ID3D11SamplerState> EnvironmentMappingMaterial::SamplerState() const
	{
		return mSamplerState;
	}

	void EnvironmentMappingMaterial::SetSamplerState(ComPtr<ID3D11SamplerState> samplerState)
	{
