...
namespace Rendering
{
    RenderingGame::RenderingGame( std::function<void*()> getWindowCallback,
    ...
    void RenderingGame::Initialize()
    {
        ...
        auto helpTextImGuiRenderBlock = make_shared<ImGuiComponent::RenderBlock>( [ this ]() {
            ...
            fpsLabel << setprecision( 4 ) << "Frame Rate: " << mFpsComponent->FrameRate()
                     << "    Total Elapsed Time: " << mGameTime.TotalGameTimeSeconds().count();
            ...
            animationEnabledLabel << "Toggle Animation (Space): "
                                  << ( mModelDemo->AnimationEnabled() ? "Enabled" : "Disabled" );
    ...
    void RenderingGame::Draw( const GameTime& gameTime )
    {
        ...
        mDirect3DDeviceContext->ClearDepthStencilView( mDepthStencilView.get(), D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL,
                                                       1.0f, 0 );
        ...
        // If the device was removed either by a disconnection or a driver upgrade, we must recreate all device
        // resources.
