...
namespace Rendering
{
	...
	void DiffuseLightingMaterial::Initialize()
	{
		...
		mVertexShader->CreateInputLayout(mGame->Direct3DDevice(), &VertexPositionTextureNormal::InputElements[0], VertexPositionTextureNormal::InputElementCount);
	...
	void DiffuseLightingMaterial::UpdateVSCBufferPerObject(FXMMATRIX worldViewProjectionMatrix, CXMMATRIX worldMatrix)
	{
